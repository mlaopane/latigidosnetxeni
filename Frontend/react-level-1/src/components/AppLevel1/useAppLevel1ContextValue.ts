import { AppLevel1ContextValue, Checkbox } from './context';
...
export default function useAppLevel1ContextValue({
    initialCheckboxes,
}: Props): AppLevel1ContextValue {
    ...
    function setCheckbox({ name, checked }: Checkbox): void {
